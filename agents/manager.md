...
5. **Review cycle.** After each task completes, run the review chain per the table above. Loop fixes through Claude until reviewers approve.
6. **Integration check.** After all tasks complete, have Claude review the full changeset holistically.
